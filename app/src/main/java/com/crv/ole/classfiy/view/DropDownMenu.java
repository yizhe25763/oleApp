...
public class DropDownMenu extends LinearLayout {
    ...
    private int popuMenuColor = 0xffffffff;
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        popuMenuColor = a.getColor(R.styleable.DropDownMenu_ddPopuMenuColor, popuMenuColor);
        ...
        addLine = a.getBoolean(R.styleable.DropDownMenu_addLine, addLine);
        a.recycle();
...
*/
        ...
        containerView.setBackgroundColor(popuMenuColor);
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (ScreenUtil.getScreenSize(getContext()).y * menuHeighPercent)));
        popupMenuViews.setVisibility(GONE);
        popupMenuViews.setBackgroundColor(popuMenuColor);
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        tab.setPadding(dpTpPx(20), dpTpPx(10), 0, dpTpPx(10));
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            RelativeLayout relativeLayout = (RelativeLayout) tabMenuView.getChildAt(current_tab_position);
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i++) {
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    RelativeLayout relativeLayout = (RelativeLayout) tabMenuView.getChildAt(i);
                    TextView textView = (TextView) relativeLayout.getChildAt(0);

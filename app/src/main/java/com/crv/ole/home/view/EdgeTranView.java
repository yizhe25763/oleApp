...
public class EdgeTranView extends FrameLayout {
    ...
    public EdgeTranView(Context context) {
        this(context, null);
    }

    public EdgeTranView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EdgeTranView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.EdgeTranView);
        position = typedArray.getInt(R.styleable.EdgeTranView_edge_position, 0);
        drawSize = typedArray.getDimension(R.styleable.EdgeTranView_edge_width, DensityUtil.dip2px(1));
        typedArray.recycle();
    }
    ...
    private int[] mGradientColors = {0xffffffff, 0xffffffff};

 ...
 * 二维码/条形码
 */
public class OleCaptureActivity extends BaseAppCompatActivity implements DecoratedBarcodeView.TorchListener {
    ...
    private void goBarCodeDetail(String text) {
        ...
        Intent intent = new Intent(mContext, BarCodeDetailActivity.class);

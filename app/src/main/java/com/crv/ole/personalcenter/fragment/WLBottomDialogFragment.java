...
public class WLBottomDialogFragment extends BaseBottomSheetDialogFragment implements View.OnClickListener {
    ...
    List<String> provinces = Arrays.asList("顺丰快递", "申通快递", "天天快递", "中通快递");
    ...
    private static WLBottomDialogFragment newInstance(String param1) {
        WLBottomDialogFragment fragment = new WLBottomDialogFragment();
    ...
    //防止重复弹出
    public static WLBottomDialogFragment showDialog(FragmentActivity activity, String params, OnConfirmClickListener onConfirmClickListener) {
        FragmentManager fragmentManager = activity.getSupportFragmentManager();
        WLBottomDialogFragment bottomDialogFragment = (WLBottomDialogFragment) fragmentManager.findFragmentByTag(TAG);
        if (null == bottomDialogFragment) {
            bottomDialogFragment = WLBottomDialogFragment.newInstance(params);
        }

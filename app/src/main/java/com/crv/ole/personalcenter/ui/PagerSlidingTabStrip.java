...
//        pager.setScanScroll(isCanScroll);
    ...
    private int selectedTabTextColor = 0x22222222;
    private int selectedPosition = 0;

    private int lastScrollX = 0;

    private int tabBackgroundResId = R.drawable.slidepager_tab_bg;
    private int tableBackgroundColor = 0xFFFFFFFF;
    private int tableSelectBackgroundColor = 0x00000000;

    private int fristBackgound = R.drawable.shape_left_whrite;
    private int lastBackgound = R.drawable.shape_right_whrite;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTableTextColor, tabTextColor);
        selectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTableTextSelectColor, selectedTabTextColor);
        tableBackgroundColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTableBackgroundColor, tableBackgroundColor);
        tableSelectBackgroundColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTableSelectBackgroundColor, tableSelectBackgroundColor);
        a.recycle();
            ...
            if (v instanceof TextView) {
                ...
                if (i == selectedPosition) {
                    ...
                    if (selectedPosition == 0) {
                        v.setBackgroundResource(fristBackgound);
                    } else if (selectedPosition == tabCount - 1) {
                        v.setBackgroundResource(lastBackgound);
                    } else {
                        v.setBackgroundColor(tableSelectBackgroundColor);
                    }
                }
            }
        }

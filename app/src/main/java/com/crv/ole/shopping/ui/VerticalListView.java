...
import com.crv.ole.shopping.callback.ObservableView;
import com.crv.ole.shopping.fragment.DetailFragment;
...
public class VerticalListView extends ListView implements ObservableView {
    private float downX;
    private float downY;
    private DetailFragment.BottomListener listener;
    ...
    public void setListener(DetailFragment.BottomListener listener){
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dy) > Math.abs(dx)) {
                    ...
                    if(isBottom() && dy < -200 && listener != null){
                        listener.loadData();
                    }
                } else {
                    //水平方向滑动

...
/**
 * @Title: ImageDisplayer.java
 * @Package com.crc.cre.crv.ewj.utils.evaluate
 * @Description: show image selected
 * Copyright:ewj.com All Rights Reserved
 * @author Rocky
 * @version V1.0
 * Create Date: 2015-3-7 上午11:39:27
 */
public class ImageDisplayer
{
	...
	{
		iv.setBackgroundResource(R.drawable.home_banner_1);
	}

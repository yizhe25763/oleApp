package com.crv.sdk.slidelistview;
...
import com.crv.sdk.slidelistview.SlideListView.SlideAction;
import com.crv.sdk.slidelistview.SlideListView.SlideMode;
import com.crv.sdk.slidelistview.wrap.FrontViewWrapLayout;
import com.crv.sdk.slidelistview.wrap.SlideItemWrapLayout;
...
public class SlideTouchListener implements OnTouchListener {
	...
	private void autoScroll(final int offset, final boolean toOpen) {
        ...
        animate(mSlideItem.frontView).translationX(moveTo).setDuration(getAnimationTime()).setListener(new ViewPropertyAnimatorListener() {
            @Override
